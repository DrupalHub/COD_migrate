...
class User extends Migration {
  ...
  public function __construct() {
    ...
    $this->source = new MigrateSourceCSV(drupal_get_path('module', 'cod_migrate') . '/csv/user/user.csv', $this->csvColumns, array('header_rows' => 1));
  ...
  function complete($entity, $row) {
    // Copy the file.
    $uri = file_unmanaged_copy(DRUPAL_ROOT . '/' . drupal_get_path('module', 'cod_migrate') . '/includes/images/users/' . $row->picture, 'public://pictures');
